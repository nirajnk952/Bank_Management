...
<div id="menuparent">
	...
	<div id="menubar">
	<ul>
<li class="menu"><a href="index.php" >HOME<span class="glyphicon glyphicon-home"></span></a></li>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered" style="border-color:black; background-color:lightyrey">
                            ...
                            <tr>
                            <th scope="col" class="text-center py-2" style="background-color:pink">Id</th>
                            <th scope="col" class="text-center py-2" style="background-color:pink">Name</th>
                            <th scope="col" class="text-center py-2" style="background-color:pink">E-Mail</th>
                            <th scope="col" class="text-center py-2" style="background-color:pink">Balance</th>
                            <th scope="col" class="text-center py-2" style="background-color:pink">Operation</th>
                            </tr>
